...
<div id="container" class="effect mainnav-lg">
                ...
                <ul class="nav navbar-top-links pull-right">
                    ...
                    <li id="dropdown-user" class="dropdown">
                        <a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
                         ...
                         <div class="username hidden-xs">   <i class="pli-male"></i>&nbsp;功能</div>
                        </a>
    ...
    <div class="boxed">
        ...
        <div id="content-container">
            ...
            <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
            <div id="page-title">
                <h1 class="page-header text-overflow">部门管理</h1>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">部门管理：添加、编辑、删除</h3>
                        </div>
                        <div class="panel-body">

                            <!-- Inline Form  -->
                            <!--===================================================-->
                            <form class="form-inline" action="DepartmentAdd" method="post">
                                <div class="form-group">
                                    <label for="demo-inline-inputmail" class="sr-only">部门编号</label>
                                    <input type="text" placeholder="部门编号" name="department_num" id="demo-inline-inputmail" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="demo-inline-inputpass" class="sr-only">部门名称</label>
                                    <input type="text" placeholder="部门名称" name="department_name" id="demo-inline-inputpass2" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="demo-inline-inputpass" class="sr-only">部门经理</label>
                                    <input type="text" placeholder="部门经理" name="department_manager" id="demo-inline-inputpass" class="form-control">
                                </div>
...
<%--                                <tr><td>${Department}</td></tr>--%>
                                ...
                                <c:forEach  items="${Department}" var="i">
                                    ...
                                    <tr>
                                        <td><%=++i%></td>
                                        <td>${i.department_num}</td>

                                        <td>${i.department_name}</td>
                                        <td>${i.department_manager}</td>
                                    </tr>
                                    <%--</c:forEach>--%>
                                </c:forEach>
                                </tbody>
