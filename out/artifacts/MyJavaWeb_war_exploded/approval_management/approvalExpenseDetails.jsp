                    ...
                    <div class="panel">
                        ...
                        <div class="panel-footer">
                            <div class="row col-lg-10" style="text-align:right">
                                ...
                                <%if(role.contains("审批人员")){%>
                                <c:if test="${ExpenseDetails.request_status == 1 && ExpenseDetails.shen_pi_status == 0 && ExpenseDetails.pay_status ==0}"><button class="btn btn-success btn-sm"  id="submitShenPiButton" onclick="change_shenpi_status('${ExpenseDetails.expense_num}','1')">通过审批</button><button class="btn btn-warning btn-sm"  id="submitShenPiButton" onclick="change_shenpi_status('${ExpenseDetails.expense_num}','2')">审批拒绝</button></c:if>
                                <c:if test="${ExpenseDetails.request_status == 1 && ExpenseDetails.shen_pi_status == 1 && ExpenseDetails.pay_status ==0}"><button class="btn btn-success"  type="button" disabled>已审批通过</button></c:if>
                                <c:if test="${ExpenseDetails.request_status == 1 && ExpenseDetails.shen_pi_status == 2 && ExpenseDetails.pay_status ==0}"><button class="btn btn-warning"  type="button" disabled>审批未通过</button></c:if>
                                <c:if test="${ExpenseDetails.request_status == 1 && ExpenseDetails.shen_pi_status == 1 && ExpenseDetails.pay_status ==1}"><button class="btn btn-success"  type="button" disabled>已付款</button></c:if>
                                <%} %>
