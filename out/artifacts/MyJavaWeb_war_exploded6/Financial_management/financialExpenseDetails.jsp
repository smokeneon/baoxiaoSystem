...
<%@ page import="leondon.web.Financial.ExpenseDetails" %>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-8 control-label">
                                                <a>${ExpenseDetails.create_file}&nbsp;&nbsp</a>
                                               <button class="btn btn-info btn-xs" onclick="download_file('${ExpenseDetails.create_file}')" type="button">下载</button>
                                            </div>
                                        </div>
...
<%--                                        </div>--%>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-lg-8 control-label"><a id="fUsername">&nbsp;&nbsp;</a></label>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">用户编号: </label>
                                        <label class="col-lg-8 control-label"><a id="fUserNum">&nbsp;&nbsp;</a></label>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-lg-8 control-label"><a id="fUserTel">&nbsp;&nbsp;</a></label>
                                    </div>


                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">工作城市:</label>
                                        <label class="col-lg-8 control-label"><a id="fUserCity">&nbsp;&nbsp;</a></label>
                                    </div>


                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">办公室:</label>
                                        <label class="col-lg-8 control-label"><a id="fUserOffice">&nbsp;</a></label>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">部门:</label>
                                        <label class="col-lg-8 control-label"><a id="fUserDepartment">&nbsp;&nbsp;</a></label>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">上级主管: </label>
                                        <label class="col-lg-8 control-label"><a id="fUserDirector">&nbsp;&nbsp;</a></label>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">手机号: </label>
                                        <label class="col-lg-8 control-label"><a id="fUserTelephone">&nbsp;&nbsp;</a></label>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-lg-3 control-label">支付宝账号: </label>
                                        <label class="col-lg-8 control-label"><a id="fUserAlipay">&nbsp;&nbsp;</a></label>
                                    </div>
                            ...
                            <div class="panel-footer">
                                <div class="row col-lg-10" style="text-align:right">
                                    ...
                                    <%if(role.contains("财务人员")){%>
                                    <c:if test="${ExpenseDetails.request_status == 1 && ExpenseDetails.shen_pi_status == 1 && ExpenseDetails.pay_status ==0}"><button class="btn btn-success" onclick="confirm_payment('${ExpenseDetails.expense_num}','1')" type="button">确认付款</button></c:if>
                                    <c:if test="${ExpenseDetails.request_status == 1 && ExpenseDetails.shen_pi_status == 1 && ExpenseDetails.pay_status ==1}"><button class="btn btn-success"  type="button" disabled>已确认付款</button></c:if>
                                    <%} %>

                                    <button class="btn btn-primary" type="button" onclick="downloadPdf()">保存</button>
                                    <button class="btn btn-default" type="button" onclick="window.location.href='FinancialList'">返回</button>
                                    <!-- </div> -->
                                </div>
                            </div>
                            <br><br><br>
                            ...
                            <ul id="mainnav-menu" class="list-group">
                                ...
                                <li class="">
                                    ...
                                    <ul class="collapse in">
                                        ...
                                        <li><a href="FinancialList">付款列表</a></li>
...
<script>
    window.onload = function () {
        ...
        $.ajax({
            ...
            success:function(user){
                ...
                $("#fUserTelephone").text(user.user_telephone);
                $("#fUserDirector").text(user.director_name);
                $("#fUserAlipay").text(user.alipay);
    ...
    function download_file(create_file) {
        var pathName=window.document.location.pathname;
        var projectName=pathName.substring(0,pathName.substr(1).indexOf('/')+1);
        window.location.href=projectName+"/DownloadFile?filename="+create_file;
    }
