 ...
 * @Version 1.0
 */
@WebServlet("/ApprovalDetails")
public class ApprovalDetails extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("approval_management/approvalExpenseDetails.jsp").forward(request,response);
//        返回结果
