...
<%--                            <div class="username hidden-xs">John Doe</div>--%>
    ...
    <div class="boxed">
        ...
        <div id="content-container">
            ...
            <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
            <div id="page-title">
                <h1 class="page-header text-overflow">办公室管理</h1>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">办公室管理：增加、编辑、删除</h3>
                        </div>
                        <div class="panel-body">
                            <!-- Inline Form  -->
                            <!--===================================================-->
                            <form class="form-inline" method="post" action="OfficeAdd">
                                <div class="form-group">
                                    <label for="demo-inline-inputmail" class="sr-only">办公室编号</label>
                                    <input type="text" name="office_num" placeholder="部门编号" id="demo-inline-inputmail" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="demo-inline-inputpass" class="sr-only">办公室名称</label>
                                    <input type="text" name="office_name" placeholder="部门名称" id="demo-inline-inputpass" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label for="demo-inline-inputpass" class="sr-only">办公室经理</label>
                                    <input type="text" name="office_manager" placeholder="部门名称" id="demo-inline-inputpass" class="form-control">
                                </div>
                                <!-- <div class="checkbox">
                            ...
                            >
                                ...
                                <tr>
                                    ...
                                    <th data-sortable="true">办公室编号</th>
                                    <th >办公室名称</th>
                                    <th>办公室经理</th>
                                </tr>
                                </thead>
...
<%--                                    </a>--%>
                            ...
                            <ul id="mainnav-menu" class="list-group">
                                ...
                                <li class="">
                                    <a href="#">
                                        <i class="psi-mouse-3"></i>
                                        <span class="menu-title">办公室管理</span>
                                        <i class="arrow"></i>
                                    </a>
