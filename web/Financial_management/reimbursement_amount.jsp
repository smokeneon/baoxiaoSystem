                ...
                <div class="col-sm-12">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">报销单金额发放：查询报销单、查看报销单详情并且付款
                            </h3>
                        </div>
...
<%--                                <div class="form-group">--%>
<%--                                    <label for="demo-inline-inputmail" class="sr-only">流程编号</label>--%>
<%--                                    <input type="email" placeholder="支付状态" id="demo-inline-inputmail" class="form-control">--%>
<%--                                </div>--%>
...
<%--                            </form>--%>
                            ...
                            <table id="demo-custom-toolbar" class="demo-add-niftycheck" data-toggle="table"
                                ...
                                <c:forEach  items="${FinancialList}" var="i">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-success btn-sm"   onclick="expense_details('${i.expense_num}')" >付款</button></td>

                                        </c:if>
                                        <c:if test="${i.pay_status == 1}"><button class="btn btn-success btn-sm" disabled>已付款</button>
                                            <button class="btn btn-default btn-sm" onclick="expense_details('${i.expense_num}')" >查看</button>
                                            </td></c:if>
...
<script>
    function expense_details(expense_num) {
        ...
        window.location.href=projectName+"/ExpenseDetails?expense_num="+expense_num;
    }
</script>
